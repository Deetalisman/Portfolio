...
export default function Home() {
  return (
    <div className="bg-[#151515] text-white h-fit lg:h-[100vh] block lg:flex justify-between px-[5%] pt-14 md:pt-20 pb-5">
      <main className="w-[100%] md:w-[80%] lg:w-[50%] xl::w-[45%]">
        <div>
          <h1 className="text-4xl md:text-5xl font-bold">Ismail Ajiboye.</h1>
          <h1 className="mt-1 sm:mt-3 text-xl font-bold">
            Frontend And React Engineer.
          </h1>
          <p className="text-gray-400 mt-5 md:mt-10">
      ...
      <aside className="w-[100%] sm:w-[80%] lg:w-[45%] overflow-auto  mt-10 lg:mt-0 no-scrollbar">
        ...
        <figure className="mt-5">
          ...
          <div className="bg-[#1c1c1f] p-8 mt-7">
            ...
            <p className="text-[0.78rem] text-gray-400">REACT + TAILWIND</p>
            <p className="mt-5 mb-7 text-gray-600 text-[0.78rem]">
